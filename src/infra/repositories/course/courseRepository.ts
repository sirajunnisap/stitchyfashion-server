...
export type courseRepository = {
  ...
  searchCourse: (searchQuery: string, sortCriteria: {}) => Promise<object[]>
  getAllCoursesByCategory:()=>Promise<any>
}
...
const courseRepositoryImp = (courseModel: MongoDBCourse): courseRepository => {
  ...
  const searchCourse = async (searchQuery: string, sortCriteria: {}): Promise<object[]> => {
